...
use App\Http\Requests\PurchaseRegisterRequest as EndpointRegisterRequest;
use App\Http\Requests\PurchaseUpdateRequest as EndpointUpdateRequest;
use App\Http\Resources\PurchaseResource as EndpointResource;
use App\Http\Resources\PurchaseCollection as EndpointCollection;
use App\Traits\ApiResponser;
use App\Services\PurchaseService as EndpointService;
use App\Models\Purchase as ModelEndpoint;

class PurchaseController extends Controller {
    use ApiResponser;

    private $endpointService;
    private $role = 'purchase';
    private $endpointName = 'compra(s)';
    private $relations = [];
