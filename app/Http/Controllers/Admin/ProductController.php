...
use App\Http\Requests\CustomerProductRegisterRequest as EndpointRegisterRequest;
use App\Http\Requests\ProductUpdateRequest as EndpointUpdateRequest;
use App\Http\Resources\ProductResource as EndpointResource;
use App\Http\Resources\ProductCollection as EndpointCollection;
use App\Traits\ApiResponser;
use App\Services\ProductService as EndpointService;
use App\Models\Product as ModelEndpoint;
...
class ProductController extends Controller {
    ...
    private $endpointName = 'produtos(s)';
    private $relations = [];
